 ...
 * @FileName: com.example.ringview.RingView.java
 * @author: Peng
 * @date: 2016-07-07 13:54
 */
...
public class CustomRoundView extends View {
    ...
    public CustomRoundView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CustomRoundView);
        mMinRadio = a.getInteger(R.styleable.CustomRoundView_min_circle_radio, 400);

        mRingWidth = a.getFloat(R.styleable.CustomRoundView_ring_width, 40);

        mSelect = a.getInteger(R.styleable.CustomRoundView_select, 7);
        mSelectAngle = a.getInteger(R.styleable.CustomRoundView_selec_angle, 3);

        mMinCircleColor = a.getColor(R.styleable.CustomRoundView_circle_color, context.getResources().getColor(R.color.white));
        mMaxCircleColor = a.getColor(R.styleable.CustomRoundView_circle_color, context.getResources().getColor(R.color.huise2));
        mRingNormalColor = a.getColor(R.styleable.CustomRoundView_ring_normal_color, context.getResources().getColor(R.color.huise));

        isShowSelect = a.getBoolean(R.styleable.CustomRoundView_is_show_select, false);
        mSelectRing = a.getInt(R.styleable.CustomRoundView_ring_color_select, 0);
        a.recycle();
